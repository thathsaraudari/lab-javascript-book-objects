...
function booksByAuthor(dictionary) {
  ...
  for (const [key, books] of Object.entries(dictionary)) {
...
function averagePageCount(booksArray) {
  ...
  let average =  totalPages / booksArray.length;
  return average;
}
